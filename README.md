...
To install the plugin in Blender, go to Edit -> Preferences -> Addons -> Instal from disk -> select the .py file.

By installing the plugin a new tab will appear in the sidebar (shortcut N)
